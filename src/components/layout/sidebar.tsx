...
const Sidebar = () => {
  ...
  return (
    <div className="flex w-fit h-full z-10 duration-300">
      <div className={`fixed left-0 top-[70px] ${sidebarOpen ? "w-[350px] xl:w-[300px] 2xl:w-[350px] xl:bg-opacity-0 bg-[#1e2a38]" : "w-[0px] "} flex flex-col lg:top-[110px] h-[calc(100%-70px)] lg:h-[calc(100%-110px)] border-primary/50 border-r border-border duration-300 overflow-hidden object-cover`}>

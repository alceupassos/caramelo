...
const ACHIEVEMENTS_DEF = [
  ...
  { id: 'tigrinho_master', name: 'Mestre Caramelinho', description: 'Ative Giros Gratis 10 vezes', icon: '🐕', requirement: 10, reward: 15000 },
  { id: 'mine_sweeper', name: 'Desminador', description: 'Revele 20 tiles seguros em Minas', icon: '💣', requirement: 20, reward: 20000 },
  { id: 'dice_god', name: 'Deus dos Dados', description: 'Acerte Roll Under 5', icon: '🎲', requirement: 1, reward: 25000 },
